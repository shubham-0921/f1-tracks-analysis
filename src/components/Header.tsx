export default function Header() {
  return (
    <header className="relative bg-[#0a0a0a] border-b border-[#1a1a1a] overflow-hidden">
      ...
      {/* Red gradient wash */}
      <div className="absolute inset-0 bg-gradient-to-r from-f1red/8 via-transparent to-transparent" />
      {/* Left accent bar */}
      <div className="absolute top-0 left-0 w-0.5 h-full bg-gradient-to-b from-f1red via-f1red/40 to-transparent" />
      {/* Bottom glow line */}
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-f1red/30 via-f1red/10 to-transparent" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="flex items-start gap-5">
          ...
          <div>
            <p className="text-f1red text-xs font-bold tracking-[0.4em] uppercase mb-2 font-mono">
            ...
            <p className="mt-3 text-gray-500 text-sm md:text-base max-w-2xl leading-relaxed">
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col">
      ...
      <span className="text-gray-600 text-[10px] uppercase tracking-[0.2em] font-medium mt-1">{label}</span>
    </div>
  );
}
